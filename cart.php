...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="sub-total"> sub total : <span>$<?php echo $sub_total = ($fetch_cart['quantity'] * $fetch_cart['price']); ?>Mil</span> </div>
      </div>
      <?php
   ...
   <div class="cart-total">
      <p>total genera: <span>$<?php echo $grand_total; ?>Mil</span></p>
      <div class="flex">
